package com.eziosc.wordtopdf.controller;
...
//        XSSFWorkbook  xssfwork=new XSSFWorkbook(new FileInputStream(fileName));
        ...
        if (pics != null) {
            for (int i = 0; i < pics.size(); i++) {
                ...
                System.out.println();
                try {
                    pic.writeImageContent(new FileOutputStream("H:/test/"
    ...
    public static void main(String argv[]) {
        try {
            convert2Html("C:\\Users\\Dell\\Desktop\\劳动合同2.doc", "H:\\劳动合同3.html");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
